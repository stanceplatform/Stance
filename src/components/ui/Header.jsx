      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={menuRef}>
            ...
            {open && (
              <div
                className="absolute right-0 mt-2 w-72 rounded-2xl bg-white shadow-lg border border-gray-200 overflow-hidden z-50"
                role="menu"
              >
                {/* Profile header */}
                <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
                  ...
                  <div className="flex flex-col items-start">
                    <span className="font-medium text-gray-900">Ashish Singh</span>
                    <span className="text-sm text-gray-500">ashish.singh@nitk.edu</span>
                  </div>
                </div>
