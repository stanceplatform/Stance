  ...
  return (
    <section className=" w-full">
      <div className="absolute bottom-0 flex flex-col justify-end w-full  p-4  "> 
        <h2 className="text-5xl text-left font-normal text-white leading-[66px] mt-5">
          {question.question}
        </h2>
        <div className="flex mt-6 w-full">
          {!hasVoted ? (
            <>
              <button
                className="relative flex-1 shrink gap-2 self-stretch mx-3 px-4 py-3 h-full text-left text-2xl tracking-wide leading-8 whitespace-wrap bg-yellow-400 rounded-md text-neutral-900 max-w-xs"
                aria-label="Yes"
              ...
              <button
                className="relative flex-1 shrink gap-2 self-stretch mx-3 px-4 py-3 h-full text-right text-2xl text-white tracking-wide leading-8 whitespace-wrap bg-purple-700 rounded-md text-neutral-900 max-w-xs"
                aria-label="No"
