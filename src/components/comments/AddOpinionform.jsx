  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-1 justify-center items-center pt-3 w-full rounded-lg">
      ...
      <input
        ...
        className="overflow-hidden flex-1 shrink gap-2 self-stretch px-4 py-3 my-auto text-base tracking-wide rounded-lg border border-solid bg-neutral-800 border-neutral-700 min-w-[240px] text-neutral-400"
