...
function ArgumentsView({
  ...
  return (
    <div className="absolute bottom-0 flex flex-col justify-end w-full py-4 px-3 custom-gradient z-10">
      ...
      {/* Arguments Section - No background, no scrollbar */}
        ...
        {isLoading ? (
          ...
          argsList.slice(0, 1).map((arg) => {
            ...
            return (
              <div
                key={arg.id}
                className="rounded-lg p-3 z-0 max-h-[200px] overflow-hidden"
              ...
              >
                ...
                <div
                  className="text-[#212121] font-inter font-normal text-base leading-[24px] text-start line-clamp-6"
      ...
      <div
        className="fixed bottom-2 left-0 right-0 max-w-[480px] mx-auto h-16 pointer-events-none z-10"
        style={{
