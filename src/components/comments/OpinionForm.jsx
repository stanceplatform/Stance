  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-1 justify-center items-center pt-3 w-full rounded-lg">
      ...
      <textarea
        ...
        className="overflow-hidden flex-1 shrink gap-2 self-stretch px-4 py-3 my-auto text-base tracking-wide rounded-lg border border-solid bg-[#3A3A3A] border-neutral-700 min-w-[240px] text-[#8D8D8Ds] text-white resize-none"
