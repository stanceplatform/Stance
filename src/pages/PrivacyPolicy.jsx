      ...
      <div className="relative w-full">
        ...
        <div className="overflow-y-auto px-4 pt-24 pb-10">
          ...
          <p className="text-left text-[15px] leading-[22px] text-[#212121] mb-4">
            Stance (“we”, “our”, “us”) is operated by an individual founder based in India. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use the Stance mobile application and related services.
          </p>

          <p className="text-left text-[15px] leading-[22px] text-[#212121] mb-8">
            By using Stance, you agree to the collection and use of information in accordance with this Privacy Policy.
          </p>
